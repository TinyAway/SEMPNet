...
class AverageMeter:
    ...
    def __init__(self, dataset):
        ...
        self.class_ids_interest = torch.tensor(self.class_ids_interest).cuda() - 1
    ...
    def update(self, inter_b, union_b, class_id, loss):
        self.intersection_buf.index_add_(1, class_id - 1, inter_b.float())
        self.union_buf.index_add_(1, class_id - 1, union_b.float())
        if loss is None:
